...
#define MULTI_M13(x)       ((x) + ((x) >> 1) - ((x) >> 5))
#define MULTI_M2(x)        ((x) + ((x) >> 5))
#define MULTI_M4(x)        (((x) << 1) + ((x) >> 1) + ((x) >> 3))
#define MULTI_M5(x)        ((x) + ((x) >> 1) + ((x) >> 2) + ((x) >> 3))
...
)
{
  ...
  for (i = 0; i < 8; i++) {
    ...
    v5 = MULTI_M13(t11 - v7);
    v7 += t11;
    t13 = MULTI_M5(t10 + t12);
    v4 = t13 - MULTI_M2(t10);
    v6 = t13 - MULTI_M4(t12) - v7;
    v5 -= v6;
    v4 -= v5;
